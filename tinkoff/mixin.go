...
type (
	...
	Config struct {
		...
		Receipts    bool                       `yaml:"receipts,omitempty" doc:"Whether to enable shopping receipt downloading. It is known to hit rate limits recently, which cool down pretty slowly, so enable at your own risk."`
		Chapters    colf.Set[string]           `yaml:"chapters,omitempty" doc:"Object chapters to synchronize." enum:"tinkoff.chapter.accounts,tinkoff.chapter.trading-operations,tinkoff.chapter.purchased-securities,tinkoff.chapter.candles" default:"[\"tinkoff.chapter.accounts\",\"tinkoff.chapter.trading-operations\",\"tinkoff.chapter.purchased-securities\",\"tinkoff.chapter.candles\"]"`
	}
